...
const TreeGraph: React.FC<TreeGraphProps> = () => {
  ...
  const nodeCanvasObject = (
    ...
    const { strokeColor, strokeWidth, radius } = circleOptions
    ...
    // Draw circle
    drawCircle(ctx, x, y, { strokeColor, strokeWidth, radius })
  ...
  return (
    <div className={`rounded m-5 bg-[#8EA8C3] shadow-lg`}>
